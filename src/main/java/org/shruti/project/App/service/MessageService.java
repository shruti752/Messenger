...
public class MessageService {
    ...
    public MessageService(){
        messages.put(1L,new Message(1,"Hello World","shruti"));
        messages.put(2L,new Message(2,"Hello Jersy","shruti"));
    }
    ...
    public List<Message> getAllMeassgesForPaginated(int start , int size){
